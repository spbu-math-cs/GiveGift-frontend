        ...
        <div className="slider fadein" style={{display: "grid"}}>
            <div className={styles.getting_started}>
                ...
                <div className={styles.hello_text}>
                    ...
                    <span className={styles.secondary}>Меня зовут Дарик, и я идеально знаю, чем порадовать друзей</span>
                    <span className={styles.secondary}>Укажи интересы друга и бюджет подарка и скорее жми на кнопочку!</span>
                </div>
            </div>
        </div>
    );
