            ...
            <ThemeProvider theme={redTheme}>
                {showAlert && !isSendRequestLoading
                    ? sendRequestError
                        ...
                        : <Alert severity="success">Заявка в друзья успешно отправлена!</Alert>
                    : <></>
                }

                <FormGroup row>
                    <TextField sx={{width: 300, '& fieldset': {borderRadius: '15px 0 0 15px'}}}
                               label="Укажите ID друга..." value={friendID}
